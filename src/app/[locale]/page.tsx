...
import { ArrowDown, CheckCircle, Trophy, Globe } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="bg-background/60 backdrop-blur-md border-border/50 hover:border-primary/50 transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_10px_30px_-15px_rgba(57,255,20,0.3)] group">
              <CardContent className="pt-8 space-y-4 text-center">
                ...
                <h3 className="text-2xl font-bold">{t('features.turf.title')}</h3>
                <p className="text-muted-foreground leading-relaxed">{t('features.turf.desc')}</p>
              </CardContent>
            </Card>
            <Card className="bg-background/60 backdrop-blur-md border-border/50 hover:border-primary/50 transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_10px_30px_-15px_rgba(57,255,20,0.3)] group">
              <CardContent className="pt-8 space-y-4 text-center">
                ...
                <h3 className="text-2xl font-bold">{t('features.booking.title')}</h3>
                <p className="text-muted-foreground leading-relaxed">{t('features.booking.desc')}</p>
              </CardContent>
            </Card>
            <Card className="bg-background/60 backdrop-blur-md border-border/50 hover:border-primary/50 transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_10px_30px_-15px_rgba(57,255,20,0.3)] group">
              <CardContent className="pt-8 space-y-4 text-center">
                ...
                <h3 className="text-2xl font-bold">{t('features.payment.title')}</h3>
                <p className="text-muted-foreground leading-relaxed">{t('features.payment.desc')}</p>
              </CardContent>
            </Card>
          </div>
        </div>
      ...
      <footer className="py-12 px-4 bg-background text-center">
        <div className="max-w-4xl mx-auto space-y-6">
          <div className="flex flex-wrap justify-center gap-8 text-sm text-muted-foreground font-medium">
            <Link href={`/${locale}/privacy`} className="hover:text-primary transition-colors">{t('footerPrivacy')}</Link>
            <Link href={`/${locale}/terms`} className="hover:text-primary transition-colors">{t('footerTerms')}</Link>
            <Link href={`/${locale}/cookies`} className="hover:text-primary transition-colors">{t('footerCookies')}</Link>
          </div>
