  ...
  const achievements: Achievement[] = [
    {
      ...
      icon: '⚽',
      progress: Math.min(1, completedMatches),
      maxProgress: 1,
      unlocked: completedMatches >= 1,
      category: 'Matches',
    },
    {
      id: '2',
      ...
      icon: '🎩',
      progress: Math.min(3, completedMatches * 2),
      maxProgress: 3,
      unlocked: completedMatches >= 2,
      category: 'Scoring',
    },
    {
      id: '3',
      ...
      icon: '🏟️',
      progress: Math.min(3, completedMatches),
      maxProgress: 3,
      unlocked: completedMatches >= 3,
      category: 'Matches',
    },
    {
      id: '4',
      ...
      icon: '🌙',
      progress: completedMatches >= 1 ? 1 : 0,
      maxProgress: 1,
      unlocked: completedMatches >= 1,
      category: 'Loyalty',
    },
    {
      ...
      icon: '🧤',
      progress: Math.min(5, completedMatches * 2),
      maxProgress: 5,
      unlocked: completedMatches >= 3,
      category: 'Matches',
    },
    {
      ...
      icon: '🏅',
      progress: Math.min(10, completedMatches * 3 + 1),
      maxProgress: 10,
      unlocked: completedMatches >= 3,
      category: 'Loyalty',
    },
