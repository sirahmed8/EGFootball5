          ...
          <div className="w-full md:w-72 space-y-3">
            ...
            <div className="grid grid-cols-3 gap-2 text-center text-xs">
              <div className="rounded-xl bg-white/5 border border-white/10 p-2">
                ...
                <div className="text-muted-foreground font-bold">Matches</div>
              </div>
              <div className="rounded-xl bg-white/5 border border-white/10 p-2">
                <div className="font-black text-lg text-amber-400">{goals}</div>
                <div className="text-muted-foreground font-bold">Goals</div>
              </div>
              <div className="rounded-xl bg-white/5 border border-white/10 p-2">
                <div className="font-black text-lg text-emerald-400">{assists}</div>
                <div className="text-muted-foreground font-bold">Assists</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        {displayed.map((ach, idx) => (
          ...
          >
            ...
            >
              {/* Category pill */}
              <span className={`absolute top-4 end-4 text-[9px] font-black uppercase px-2 py-0.5 rounded-full border ${CATEGORY_COLORS[ach.category]}`}>
                {ach.category}
              </span>
              ...
              <div className="flex items-start gap-3">
                ...
                {ach.unlocked ? (
                  <span className="flex items-center gap-1 px-2.5 py-1 rounded-full bg-emerald-500/20 text-emerald-400 border border-emerald-500/30 text-xs font-black mt-1">
                    <CheckCircle2 className="w-3.5 h-3.5" /> Unlocked
                  </span>
                ) : (
                  <span className="flex items-center gap-1 px-2.5 py-1 rounded-full bg-white/5 text-muted-foreground border border-white/10 text-xs font-bold mt-1">
